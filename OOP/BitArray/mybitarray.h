...
* @param n Index of bit to set, must be less then BitArray bitlen.
...
* @param i Index of bit to get, must be less then BitArray bitlen.
* @return Val of i'th bit.
*/
    bool operator[](int i) const;
/**
* @brief Set false in bit string in particular pos.
* @param n Index of bit to reset, must be less then BitArray bitlen.
* @return this BitArray pointer.
*/
